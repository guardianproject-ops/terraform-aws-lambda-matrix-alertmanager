...
exports.SecretStorage = exports.SECRET_STORAGE_ALGORITHM_V1_CURVE25519 = exports.SECRET_STORAGE_ALGORITHM_V1_AES = void 0;
...
*/
const SECRET_STORAGE_ALGORITHM_V1_AES = "m.secret_storage.v1.aes-hmac-sha2"; // don't use curve25519 for writing data.

exports.SECRET_STORAGE_ALGORITHM_V1_AES = SECRET_STORAGE_ALGORITHM_V1_AES;
const SECRET_STORAGE_ALGORITHM_V1_CURVE25519 = "m.secret_storage.v1.curve25519-aes-sha2";
/**
 * Implements Secure Secret Storage and Sharing (MSC1946)
 * @module crypto/SecretStorage
 */

exports.SECRET_STORAGE_ALGORITHM_V1_CURVE25519 = SECRET_STORAGE_ALGORITHM_V1_CURVE25519;
...
class SecretStorage extends _events.EventEmitter {
    ...
    for (const keyId of Object.keys(secretInfo.encrypted)) {
      ...
      switch (keyInfo.algorithm) {
        ...
        case SECRET_STORAGE_ALGORITHM_V1_CURVE25519:
          if (keyInfo.pubkey && (encInfo.ciphertext && encInfo.mac && encInfo.ephemeral || encInfo.passthrough)) {
            keys[keyId] = keyInfo;
          }
  ...
  async isStored(name, checkKey) {
    ...
    const ret = {}; // check if secret is encrypted by a known/trusted secret and
      ...
      case SECRET_STORAGE_ALGORITHM_V1_CURVE25519:
        {
          ...
          const decryption = {
            ...
            decrypt: async function (encInfo) {
              return pkDecryption.decrypt(encInfo.ephemeral, encInfo.mac, encInfo.ciphertext);
            },
