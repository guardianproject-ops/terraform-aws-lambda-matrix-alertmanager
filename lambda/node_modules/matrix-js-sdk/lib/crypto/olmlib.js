...
async function ensureOlmSessionsForDevices(olmDevice, baseApis, devicesByUser, force, otkTimeout, failedServers) {
  ...
  try {
    ...
    _logger.logger.log("failed to claim one-time keys", e, devicesWithoutSession);
