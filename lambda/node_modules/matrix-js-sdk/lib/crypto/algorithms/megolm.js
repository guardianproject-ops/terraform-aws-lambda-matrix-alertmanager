    ...
    await Promise.all([(async () => {
      ...
      if (!singleOlmCreationPhase && Date.now() - start < 10000) {
        ...
        (async () => {
          ...
          await this._shareKeyWithDevices(session, key, payload, retryDevices, failedDevices);
...
MegolmEncryption.prototype._shareKeyWithDevices = async function (session, key, payload, devicesByUser, errorDevices, otkTimeout, failedServers) {
  const devicemap = await olmlib.ensureOlmSessionsForDevices(this._olmDevice, this._baseApis, devicesByUser, otkTimeout, failedServers);
